...
import defaultClasses from './list.shimmer.module.css';
import { useStyle } from '@magento/venia-ui/lib/classify';
import Shimmer from '@magento/venia-ui/lib/components/Shimmer';
import { useMediaQuery } from '@magento/peregrine/lib/hooks/useMediaQuery';

/**
 * Page Builder Banner List Shimmer component.
 *
 * @typedef ListShimmer
 ...
 *
 * @returns {React.Element} A React component that displays a List Shimmer.
 */
