...
import defaultClasses from './static.shimmer.module.css';
import { useStyle } from '@magento/venia-ui/lib/classify';
import Shimmer from '@magento/venia-ui/lib/components/Shimmer';
import { useMediaQuery } from '@magento/peregrine/lib/hooks/useMediaQuery';

/**
 * Page Builder Banner Static Shimmer component.
 *
 * @typedef StaticShimmer
 * @kind functional component
 *
 * @param {props} props React component props
 *
 * @returns {React.Element} A React component that displays a Static Shimmer.
 */
const StaticShimmer = props => {
...
/**
 * Props for {@link StaticShimmer}
 *
 * @typedef props
 *
 * @property {Object} classes An object containing the class names for the Static
